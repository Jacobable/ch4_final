...
public class BoardDaoImplTest {
    ...
    public  void searchSelectPageTest()throws Exception{
        boardDao.deleteAll();
        for(int i=1;i<=20;i++){
            BoardDto boardDto=new BoardDto("title"+i,"adfdfdf","asdf"+i);
        ...
        assertTrue(list.size()==2);//1부터20중에 title2,title20

         sc= new SearchCondition(1,10,"asdf2","W");
         list=boardDao.searchSelectPage(sc);
        System.out.println("list="+list);
        assertTrue(list.size()==2);//1부터20중에 asdf2,asdf20
    }
    ...
    public  void searchResultCntTest()throws Exception{
        ...
        assertTrue(cnt==2);//1부터20중에 title2,title20
